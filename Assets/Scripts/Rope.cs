...
public class Rope : MonoBehaviour
{
    ...
    void Start()
    {
        _previousPositionsBuffer = new GraphicsBuffer(GraphicsBuffer.Target.Structured, 32, 3 * sizeof(uint));
        _previousPositionsBuffer.SetData(new Vector3[32]);
        _mutexBuffer = new GraphicsBuffer(GraphicsBuffer.Target.Structured, 32, sizeof(uint));
        _mutexBuffer.SetData(new uint[32]);
